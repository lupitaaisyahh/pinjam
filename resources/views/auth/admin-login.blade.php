...
<body class="login">
    ...
    <div class="wrapper wrapper-login">
        <div class="container container-login animated fadeIn">
            ...
            <h3 class="text-center mb-5">Sistem Informasi<br>Peminjaman Saran Prasarana <br> - Login Admin -</h3>
            <form action="{{ route('admin.logins') }}" method="post" class="needs-validation" novalidate>
                @csrf
