...
<body class="login">
    ...
    <div class="wrapper wrapper-login">
        <div class="container container-login animated fadeIn">
            ...
            <!-- judul -->
            <h3 class="text-center mb-5">Sistem Informasi<br>Peminjaman Saran Prasarana</h3>
            <!-- form login -->
            <form action="{{ route('mahasiswa.signups') }}" method="post" class="needs-validation" novalidate>
                @csrf
                @if($errors->any())
                <div id="error">
                ...
                <div class="form-group form-floating-label">
                    ...
                    <input type="text" id="nama" name="nama" class="form-control input-border-bottom" autocomplete="off" required>
                ...
                <div class="form-group form-floating-label">
                    <div class="user-icon"><i class="fas fas fa-user"></i></div>
                    <input type="text" id="username" name="nim" class="form-control input-border-bottom" autocomplete="off" required>
                    <label for="username" class="placeholder">NIM</label>
                ...
                <div class="form-action mt-2">
                    <!-- button login -->
                    <input type="submit" name="Sign Up" value="SIGN UP" class="btn btn-success btn-rounded btn-login btn-block">
                </div>
