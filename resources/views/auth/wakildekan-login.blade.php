...
<body class="login">
    ...
    <div class="wrapper wrapper-login">
        <div class="container container-login animated fadeIn">
            ...
            <!-- judul -->
            <h3 class="text-center mb-5">Sistem Informasi<br>Peminjaman Saran Prasarana <br> - Login Wakil Dekan -</h3>
            <!-- form login -->
            <form action="{{ route('wakildekan.logins') }}" method="post" class="needs-validation" novalidate>
                @csrf
