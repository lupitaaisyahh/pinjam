         ...
         <div class="card-body">
            <div class="row">
               ...
               <div class="col-md-3">
                    <div class="form-group">
                     <label>NIM</label>
                     <input type="text" name="nama" class="form-control" readonly value="{{Auth::user()->nim}}">
                  </div>
               </div>
               <div class="col-md-3">
                    <div class="form-group">
                     <label>Jurusan</label>
                     <input type="text" name="nama" class="form-control" readonly value="{{Auth::user()->jurusan}}">
                  </div>
               </div>
               <div class="col-md-3">
                    <div class="form-group">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formAdd" method="POST" action="{{ route('mahasiswa.transaksi.peminjamanruangan.tambah')}}" enctype="multipart/form-data" validate>
                  @csrf
                  <div class="form-group">
                     <label>Nama</label>
                  ...
                  <div class="form-group">
                     <label>NIM</label>
                     <input type="text" class="form-control" name="nim" readonly value="{{Auth::user()->nim}}">
                  </div>
                  <div class="form-group">
...
<script>
   ...
   $(document).on('click', '#tombollihat', function() {
      ...
      var url = '{{ route("mahasiswa.transaksi.peminjamanruangan.detail", ":id") }}';
