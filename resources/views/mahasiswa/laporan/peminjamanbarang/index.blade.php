...
<form method="post" enctype="multipart/form-data" class="form-horizontal" id="formhapus" action="{{ route('mahasiswa.laporan.peminjamanbarang.hapus')}}">
   @csrf
...
<div class="modal fade" id="pengembalian" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formAdd" method="POST" action="{{ route('mahasiswa.laporan.peminjamanbarang.pengembalian')}}" enctype="multipart/form-data" validate>
                  @csrf
...
<script>
   ...
   $(document).ready(function () {
      ...
      $(document).on("click", ".pengembalian", function (e) {
          var id = $(this).data("id");
          var url = '{{ route("mahasiswa.laporan.peminjamanbarang.detail", ":id") }}';
   ...
   $(function() {
       clearSession();
        var table = $('#example2').DataTable({
           ...
           ajax: {
           url: '{!! route('mahasiswa.laporan.peminjamanbarang.data') !!}',
             data: function (d) {
