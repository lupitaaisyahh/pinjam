...
<form method="post" enctype="multipart/form-data" class="form-horizontal" id="formhapus" action="{{ route('dosen.laporan.peminjamanruangan.hapus')}}">
   @csrf
...
<div class="modal fade" id="pengembalian" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formAdd" method="POST" action="{{ route('dosen.laporan.peminjamanruangan.pengembalian')}}" enctype="multipart/form-data" validate>
                  @csrf
...
<script>
   ...
   $(document).ready(function () {
        $(document).on("click", ".pengembalian", function (e) {
          var id = $(this).data("id");
          var url = '{{ route("dosen.laporan.peminjamanruangan.detail", ":id") }}';
        ...
        $.ajax({
            ...
            success: function (data) {
               console.log(data);
                ...
                $("#j_kel").text(': '+data.dosen.j_kel);
                $("#no_telp").text(': '+data.dosen.no_telp);
   ...
   $(function() {
       clearSession();
        var table = $('#example2').DataTable({
           ...
           ajax: {
           url: '{!! route('dosen.laporan.peminjamanruangan.data') !!}',
             data: function (d) {
