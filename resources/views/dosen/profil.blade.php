            ...
            <div class="d-flex align-items-left align-items-md-top flex-column flex-md-row">
                <div class="page-header text-white">
                    ...
                    <ul class="breadcrumbs">
                        ...
                        <li class="nav-item"><a href="#" class="text-white">Dosen</a></li>
                        <li class="separator"><i class="flaticon-right-arrow"></i></li>
            ...
            <div class="card">
                ...
                <div class="box-body">
                    <div class="col-md-12" style="margin-bottom:3em;">
                            <form method="post" enctype="multipart/form-data" class="form-horizontal" action="{{ route('dosen.ubahprofil', Auth::user()->id)}}">
                                @csrf
                                @if($errors->any())
                                <div class="col-md-12">
