            ...
            <div class="d-flex align-items-left align-items-md-top flex-column flex-md-row">
                <div class="page-header text-white">
                    ...
                    <ul class="breadcrumbs">
                        ...
                        <li class="nav-item"><a href="#" class="text-white">Wakil Dekan</a></li>
                        <li class="separator"><i class="flaticon-right-arrow"></i></li>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Profil Wakil Dekan</div>
                </div>
                <div class="box-body">
                    <div class="col-md-12" style="margin-bottom:3em;">
                            <form method="post" enctype="multipart/form-data" class="form-horizontal" action="{{ route('wakildekan.ubahprofil', Auth::user()->id)}}">
                                @csrf
                                @if($errors->any())
                                <div class="col-md-12">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="username" class="form-control" placeholder="Masukkan Username" required oninvalid="this.setCustomValidity('Masukkan Username')" oninput="this.setCustomValidity('')" value="{{ $data->username }}">
                                    </div>
                                    <div class="form-group">
...
@section('js')
<script>
    $("#profilwakildekan").addClass("active");
</script>
@endsection