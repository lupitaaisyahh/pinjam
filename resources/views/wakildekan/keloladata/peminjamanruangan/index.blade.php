...
<div class="modal fade" id="verifikasi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formAdd" method="POST" action="{{ route('wakildekan.keloladata.peminjamanruangan.verifikasi')}}" enctype="multipart/form-data" validate>
                    @csrf
...
<div class="modal fade" id="verifikasis" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formAdd" method="POST" action="{{ route('wakildekan.keloladata.peminjamanruangan.verifikasis')}}" enctype="multipart/form-data" validate>
                    @csrf
                    <div class="form-group">
                        <label>Nama</label>
                        <input type="hidden" name="tgl_transaksi" value="<?php echo date('d-m-Y');?>"/>
...
<script>
    ...
    $(document).ready(function () {
        $(document).on("click", ".verifikasi", function (e) {
          var id = $(this).data("id");
          var url = '{{ route("wakildekan.keloladata.peminjamanruangan.detail", ":id") }}';
        ...
        $(document).on("click", ".verifikasis", function (e) {
          var id = $(this).data("id");
          var url = '{{ route("wakildekan.keloladata.peminjamanruangan.details", ":id") }}';
          url = url.replace(':id', id);
          $.ajax({
              type: 'GET',
              url: url,
    ...
    $(function() {
        var table = $('#example3').DataTable({
           ...
           ajax: {
           url: '{!! route('wakildekan.keloladata.peminjamanruangan.data') !!}',
           },
           columns: [
        ...
        var tables = $('#example2').DataTable({
           ...
           ajax: {
           url: '{!! route('wakildekan.keloladata.peminjamanruangan.datas') !!}',
           },
           columns: [
               { data : 'DT_RowIndex', name : 'id' },
               { data : 'gedung', name : 'gedung'},
