    ...
    <div class="page-inner mt--5">
        ...
        <div class="card">
            <div class="card-header">
                <div class="card-title">Data Peminjaman Barang {{Helper::ambilBarang($id)}} (Dosen)</div>
            </div>
            <div class="card-body">
        ...
        <div class="card">
            <div class="card-header">
                <div class="card-title">Data Peminjaman Barang {{Helper::ambilBarang($id)}} (Mahasiswa)</div>
            </div>
            <div class="card-body">
                <div class="col-md-3 pull-right">
                    <div class="input-group">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(document).on("click", ".detail", function (e) {
            var id = $(this).data("id");
            var url = '{{ route("wakildekan.laporan.peminjamanbarang.detail.detail", ":id") }}';
        ...
        $(document).on("click", ".details", function (e) {
            var id = $(this).data("id");
            var url = '{{ route("wakildekan.laporan.peminjamanbarang.detail.details", ":id") }}';
            url = url.replace(':id', id);
            $.ajax({
                type: 'GET',
                url: url,
                success: function (datax) {
                    ...
                    $("#status_pjss").text(': '+datax.transaksi.status_pj);
    ...
    $(function() {
        ...
        var table = $('#example2').DataTable({
           ...
           ajax: {
           url: '{!! route('wakildekan.laporan.peminjamanbarang.detail.data', $id) !!}',
             data: function (d) {
    ...
    $(function() {
        ...
        var table = $('#example22').DataTable({
           ...
           ajax: {
           url: '{!! route('wakildekan.laporan.peminjamanbarang.detail.datas', $id) !!}',
             data: function (d) {
