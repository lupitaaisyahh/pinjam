      ...
      <div class="page-inner py-45">
         <div class="d-flex align-items-left align-items-md-top flex-column flex-md-row">
            <div class="page-header text-white">
               <h4 class="page-title text-white"><i class="fas fa-users mr-2"></i> User Operator</h4>
               <ul class="breadcrumbs">
                  <li class="nav-home"><a href="#"><i class="flaticon-home text-white"></i></a></li>
                  <li class="separator"><i class="flaticon-right-arrow"></i></li>
                  <li class="nav-item"><a href="#" class="text-white">User Operator</a></li>
                  <li class="separator"><i class="flaticon-right-arrow"></i></li>
   ...
   <div class="page-inner mt--5">
      ...
      <div class="card">
         <div class="card-header">
            <div class="card-title">User Operator</div>
         </div>
         <div class="card-body">
...
<form method="post" enctype="multipart/form-data" class="form-horizontal" id="formhapus" action="{{ route('admin.kelolauser.operator.hapus')}}">
   @csrf
...
<div class="modal fade" id="tambah">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         ...
         <form method="POST" action="{{ route('admin.kelolauser.operator.tambah')}}" enctype="multipart/form-data" validate>
            <div class="modal-body">
               @csrf
               <div class="form-group">
                  <label>Nama Operator</label>
                  <input type="text" name="nama" class="form-control" placeholder="Masukkan Nama Operator" required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="this.setCustomValidity('')">
               </div>
               <div class="form-group">
...
<div class="modal fade" id="edit">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         ...
         <form method="POST" action="{{ route('admin.kelolauser.operator.ubah')}}" enctype="multipart/form-data" validate>
            <div class="modal-body">
               @csrf
               <div class="form-group">
                  <input type="hidden" name="id" id="id">
                  <label>Nama Operator</label>
                  <input type="text" name="nama" id="namas" class="form-control" placeholder="Masukkan Nama Operator" required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="this.setCustomValidity('')">
               </div>
               <div class="form-group">
                  <label>Jenis Kelamin</label>
   ...
   $(function() {
       clearSession();
        var table = $('#example2').DataTable({
           ...
           ajax: {
           url: '{!! route('admin.kelolauser.operator.data') !!}',
             data: function (d) {
