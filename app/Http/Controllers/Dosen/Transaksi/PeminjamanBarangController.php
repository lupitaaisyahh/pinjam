...
class PeminjamanBarangController extends Controller
{
    ...
    {
        $barang = Barang::where('status', 'Aktif')->where('jumlah_stok', '>', '0')->get();
        $jenis = JenisBarang::all();
        return view('dosen.transaksi.peminjamanbarang.index',compact(['jenis','barang']));
    }
    ...
    public function tambah(Request $req)
    {
        ...
        return redirect()->route('dosen.laporan.peminjamanbarang.index')->with('pesan', 'Peminjaman Barang Berhasil !');
    }
