...
class PeminjamanBarangController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dosen.laporan.peminjamanbarang.index',compact(['jenis','barang']));
    }

    public function data(Request $request)
    {
        $datas = PeminjamanBarang::query()->orderBy('id', 'DESC')->where('jenis_pinjaman', 1)->where('dosen_id', Auth::user()->id);
        if ($request->statusss !='') 
        {
    ...
    public function pengembalian(Request $req)
    {
        ...
        return redirect()->route('dosen.laporan.peminjamanbarang.index')->with('pesan', 'Data Berhasil Di Simpan !');
    }
    ...
    public function hapus(Request $req)
    {
        ...
        $peminjaman->delete();
        return redirect()->route('dosen.laporan.peminjamanbarang.index')->with('pesan', 'Data Berhasil Di Hapus!');
    }
