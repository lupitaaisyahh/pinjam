...
class PeminjamanRuanganController extends Controller
{
    ...
    public function index()
    {
        $ruangan = Ruangan::all();
        $gedung = Gedung::all();
        return view('dosen.laporan.peminjamanruangan.index',compact(['ruangan','gedung']));
    }

    public function data(Request $request)
    {
        $datas = PeminjamanRuangan::query()->orderBy('id', 'DESC')->where('jenis_pinjaman', 1)->where('dosen_id', Auth::user()->id);
        if ($request->statusss !='') 
        {
    ...
    public function hapus(Request $req)
    {
        ...
        return redirect()->route('dosen.laporan.peminjamanruangan.index')->with('pesan', 'Data Berhasil Di Hapus!');
    }
    ...
    public function pengembalian(Request $req)
    {
        ...
        return redirect()->route('dosen.laporan.peminjamanruangan.index')->with('pesan', 'Data Berhasil Di Simpan !');
    }
    ...
    public function detail($id)
    {
        ...
        $data['dosen'] = Dosen::find(Auth::user()->id);
