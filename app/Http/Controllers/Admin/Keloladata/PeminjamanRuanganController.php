...
class PeminjamanRuanganController extends Controller
{
    ...
    {
        $ruangan = Ruangan::all();
        return view('admin.keloladata.peminjamanruangan.index',compact(['ruangan']));
    }
    ...
    public function data(Request $request)
    {
        ...
        {
            if (isset($data->ruangan->gedung_id)) {
    ...
    public function verifikasi(Request $req)
    {
        ...
        if ($validator->fails()) {
            ...
            try{
                ...
                if ($datas->status_op == 1) {
                    ...
                    $text29 = 'Peminjaman Terverifikasi Ruangan Bisa Digunakan.';
                }else{
        ...
        return redirect()->route('admin.keloladata.peminjamanruangan.index')->with('pesan', 'Data Berhasil Di Verifikasi !');
    }
    ...
    public function hapus(Request $req)
    {
        ...
        $ruanganx->delete();
        return redirect()->route('admin.keloladata.peminjamanruangan.index')->with('pesan', 'Data Berhasil Di Hapus!');
    }
