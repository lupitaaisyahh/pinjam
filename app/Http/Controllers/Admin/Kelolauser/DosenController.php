...
class DosenController extends Controller
{
    ...
    {
        return view('admin.kelolauser.dosen.index');
    }
    ...
    public function tambah(Request $req)
    {
        $validator = Validator::make($req->all(), [
            'nama' => 'required',
            'username' => 'required|unique:user_dosen',
            'email' => 'required',
            'j_kel' => 'required',
            'no_telp' => 'required',
            'password' => 'required',
        ...
        if ($validator->fails()) {
            ...
            return redirect()->route('admin.kelolauser.dosen.index')->with('pesan', 'Data Berhasil Di Tambahkan!');
        }
    }
    ...
    public function hapus(Request $req)
    {
        ...
        return redirect()->route('admin.kelolauser.dosen.index')->with('pesan', 'Data Berhasil Di Hapus!');
    }
