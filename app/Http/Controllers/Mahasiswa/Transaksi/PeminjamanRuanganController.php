...
class PeminjamanRuanganController extends Controller
{
    ...
    {
        $gedung = Gedung::all();
        return view('mahasiswa.transaksi.peminjamanruangan.index',compact(['gedung']));
    }
    ...
    public function tambah(Request $req)
    {
        ...
        if ($validator->fails()) {
            ...
            try{
                ...
                $text3 = 'Nama : '.$req->nama;
                $text4 = 'NIM : '.$req->nim;
                $text5 = 'Tanggal Peminjaman: '.Helper::indonesian_date($req->tgl_transaksi,'j F Y | H:i');
        ...
        return redirect()->route('mahasiswa.laporan.peminjamanruangan.index')->with('pesan', 'Peminjaman Barang Berhasil !');
    }
