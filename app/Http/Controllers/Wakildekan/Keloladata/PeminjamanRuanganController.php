...
class PeminjamanRuanganController extends Controller
{
    ...
    {
        $ruangan = Ruangan::all();
        return view('wakildekan.keloladata.peminjamanruangan.index',compact(['ruangan']));
    }
    ...
    public function verifikasi(Request $req)
    {
        ...
        if ($validator->fails()) {
            ...
            try{
                ...
                if ($datas->status_wd == 1) {
                    ...
                    $text26 = 'Tanggal Verifikasi : '. $datas->tgl_verifikasi_wd;
        ...
        return redirect()->route('wakildekan.keloladata.peminjamanruangan.index')->with('pesan', 'Data Berhasil Di Verifikasi !');
    }
