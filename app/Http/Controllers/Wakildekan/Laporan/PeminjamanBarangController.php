...
class PeminjamanBarangController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('wakildekan.laporan.peminjamanbarang.index',compact(['jenis','barang']));
    }
    ...
    public function data(Request $request)
    {
        ...
        if ($request->statusxx !='') 
        {
            $datas = $datas->where('status', 'like', '%' . $request->statusxx . '%');
        }
        ...
        ->addColumn('aksi', function ($data)
        {
            return '
                <center>
                        <a href="'.route("wakildekan.laporan.peminjamanbarang.detail.index", $data->id).'" class="btn btn-icon btn-round btn-info btn-sm">
