...
class WakilDekanController extends Controller
{
    ...
    {
        $this->middleware('auth:wakildekan');
    }
    ...
    public function index()
    {
        ...
        return view('dashboard.wakildekan', compact(['data','riwayatruangan','riwayatbarang','riwayat','riwayats']));

    }  

    public function profil()
    {
        $data = WakilDekan::find(Auth::user()->id);
        return view('wakildekan.profil', compact(['data']));
    }
    ...
    public function ubahprofil(Request $req)
    {
        ...
        if ($validator->fails()) {
            ...
            $objek = WakilDekan::find(Auth::user()->id);
            $objek->nama = $req->nama;
            ...
            $objek->save();
            return redirect()->route('wakildekan.profil',  Auth::user()->id)->with('pesan', 'Data Berhasil Di Ubah!');
